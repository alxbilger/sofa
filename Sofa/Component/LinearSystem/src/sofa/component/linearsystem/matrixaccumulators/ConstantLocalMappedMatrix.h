...
class ConstantLocalMappedMatrix :
    public ConstantLocalMatrix<TComponentType>,
    public AssemblingMappedMatrixAccumulator<TComponentType, TBlockType>
{
public:
    SOFA_CLASS2(ConstantLocalMappedMatrix, ConstantLocalMatrix<TComponentType>, SOFA_TEMPLATE2(AssemblingMappedMatrixAccumulator, TComponentType, TBlockType));
...
void ConstantLocalMappedMatrix<ComponentType, TBlockType>::add(const no_check_policy&, sofa::SignedIndex row, sofa::SignedIndex col,
    float value)
{
