...
class SparsityPatternLocalMappedMatrix :
    public SparsityPatternLocalMatrix<TComponentType>,
    public AssemblingMappedMatrixAccumulator<TComponentType, TBlockType>
{
public:
    SOFA_CLASS2(SparsityPatternLocalMappedMatrix, SparsityPatternLocalMatrix<TComponentType>, SOFA_TEMPLATE2(AssemblingMappedMatrixAccumulator, TComponentType, TBlockType));
...
void SparsityPatternLocalMappedMatrix<ComponentType, TBlockType>::add(const core::matrixaccumulator::no_check_policy&, sofa::SignedIndex row, sofa::SignedIndex col,
    float value)
{
