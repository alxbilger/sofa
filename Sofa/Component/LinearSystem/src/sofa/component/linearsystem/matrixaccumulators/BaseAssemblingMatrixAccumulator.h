...
class BaseAssemblingMatrixAccumulator : public sofa::core::matrixaccumulator::get_base_object_strong_type<TComponentType>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(BaseAssemblingMatrixAccumulator, TComponentType), sofa::core::matrixaccumulator::get_base_object_strong_type<TComponentType>);
...
BaseAssemblingMatrixAccumulator<ComponentType>::BaseAssemblingMatrixAccumulator()
: Inherit1()
...
template<class ComponentType>
void BaseAssemblingMatrixAccumulator<ComponentType>::setMatrixSize(const sofa::type::Vec2u& matrixSize)
{
    d_matrixSize.setValue(matrixSize);
}

template <class ComponentType>
sofa::type::Vec2u BaseAssemblingMatrixAccumulator<ComponentType>::getMatrixSize() const
{
    return d_matrixSize.getValue();
}

template <class ComponentType>
void BaseAssemblingMatrixAccumulator<ComponentType>::setPositionInGlobalMatrix(const sofa::type::Vec2u& pos)
{
...
template<class ComponentType>
void BaseAssemblingMatrixAccumulator<ComponentType>::setFactor(SReal factor)
{
...
template<class ComponentType>
void BaseAssemblingMatrixAccumulator<ComponentType>::setGlobalMatrix(sofa::linearalgebra::BaseMatrix* globalMatrix)
{
    m_globalMatrix = globalMatrix;
}

template <class TComponentType>
type::Vec<2, unsigned> BaseAssemblingMatrixAccumulator<TComponentType>::getPositionInGlobalMatrix() const
{
