 ...
 */
template<class TComponentType, class TBlockType>
class AssemblingMappedMatrixAccumulator : public virtual AssemblingMatrixAccumulator<TComponentType>
{
public:
    SOFA_CLASS(AssemblingMappedMatrixAccumulator, AssemblingMatrixAccumulator<TComponentType>);
...
template <class TMatrixAccumulator, class TBlockType>
void AssemblingMappedMatrixAccumulator<TMatrixAccumulator, TBlockType>::add(const core::matrixaccumulator::no_check_policy&, sofa::SignedIndex row, sofa::SignedIndex col,
    float value)
{
...
template <class TMatrixAccumulator, class TBlockType>
void AssemblingMappedMatrixAccumulator<TMatrixAccumulator, TBlockType>::clear()
{}

template <class ComponentType, class TBlockType>
void AssemblingMappedMatrixAccumulator<ComponentType, TBlockType>::shareMatrix(
...
template <class ComponentType, class TBlockType>
const std::shared_ptr<LocalMappedMatrixType<TBlockType>>& AssemblingMappedMatrixAccumulator<ComponentType, TBlockType>::
getMatrix() const
{
...
template <class ComponentType, class TBlockType>
AssemblingMappedMatrixAccumulator<ComponentType, TBlockType>::AssemblingMappedMatrixAccumulator()
: Inherit1()
{
