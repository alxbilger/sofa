...
class SparsityPatternLocalMatrix : public virtual AssemblingMatrixAccumulator<TComponentType, TStrategy>
{
public:
    SOFA_CLASS(SparsityPatternLocalMatrix, SOFA_TEMPLATE2(AssemblingMatrixAccumulator, TComponentType, TStrategy));
...
void SparsityPatternLocalMatrix<ComponentType, TStrategy>::add(const core::matrixaccumulator::no_check_policy&, sofa::SignedIndex row, sofa::SignedIndex col, float value)
{
...
template <class ComponentType, class TStrategy>
void SparsityPatternLocalMatrix<ComponentType, TStrategy>::add(const core::matrixaccumulator::no_check_policy&, sofa::SignedIndex row, sofa::SignedIndex col, double value)
{
    insertionOrderList.emplace_back(row + this->m_cachedPositionInGlobalMatrix[0], col + this->m_cachedPositionInGlobalMatrix[1]);
    Inherit1::add(core::matrixaccumulator::no_check, row, col, value);
}
...
template <class ComponentType, class TStrategy>
void SparsityPatternLocalMatrix<ComponentType, TStrategy>::add(const core::matrixaccumulator::no_check_policy&, sofa::SignedIndex row, sofa::SignedIndex col,
