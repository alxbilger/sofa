...
public:
    ...
    core::objectmodel::BaseContext* getSolveContext() const;
...
protected:
    ...
    static SReal getFactorIncludingRayleighDamping(const sofa::core::MechanicalParams* mparams, const sofa::core::behavior::BaseMass* mass);
    static SReal getFactorIncludingRayleighDamping(const sofa::core::MechanicalParams* mparams, const sofa::core::behavior::BaseForceField* forceField);
    static SReal getFactorIncludingRayleighDamping(const sofa::core::MechanicalParams* mparams, const sofa::core::BaseMapping* mapping);
};
