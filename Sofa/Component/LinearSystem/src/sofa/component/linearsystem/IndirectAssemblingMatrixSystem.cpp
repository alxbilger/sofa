...
template<>
void IndirectAssemblingLocalMatrix<sofa::core::behavior::BaseForceField, sofa::type::Mat3x3d>::addContributionsToMatrix(sofa::linearalgebra::BaseMatrix* globalMatrix, SReal factor, const sofa::type::Vec2u& positionInMatrix)
{
    if (globalMatrix)
    {
...
template<>
void IndirectAssemblingLocalMatrix<sofa::core::behavior::BaseForceField, sofa::type::Mat3x3f>::addContributionsToMatrix(sofa::linearalgebra::BaseMatrix* globalMatrix, SReal factor, const sofa::type::Vec2u& positionInMatrix)
{
    if (globalMatrix)
    {
...
template class SOFA_COMPONENT_LINEARSYSTEM_API IndirectAssemblingLocalMatrix<sofa::core::behavior::BaseForceField, float>;
template class SOFA_COMPONENT_LINEARSYSTEM_API IndirectAssemblingLocalMatrix<sofa::core::behavior::BaseForceField, double>;
template class SOFA_COMPONENT_LINEARSYSTEM_API IndirectAssemblingLocalMatrix<sofa::core::behavior::BaseForceField, sofa::type::Mat3x3f>;
template class SOFA_COMPONENT_LINEARSYSTEM_API IndirectAssemblingLocalMatrix<sofa::core::behavior::BaseForceField, sofa::type::Mat3x3d>;

template class SOFA_COMPONENT_LINEARSYSTEM_API IndirectAssemblingLocalMatrix<sofa::core::behavior::BaseMass, float>;
template class SOFA_COMPONENT_LINEARSYSTEM_API IndirectAssemblingLocalMatrix<sofa::core::behavior::BaseMass, double>;
template class SOFA_COMPONENT_LINEARSYSTEM_API IndirectAssemblingLocalMatrix<sofa::core::behavior::BaseMass, sofa::type::Mat3x3f>;
template class SOFA_COMPONENT_LINEARSYSTEM_API IndirectAssemblingLocalMatrix<sofa::core::behavior::BaseMass, sofa::type::Mat3x3d>;
