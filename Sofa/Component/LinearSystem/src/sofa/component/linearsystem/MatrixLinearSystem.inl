...
void MatrixLinearSystem<TMatrix, TVector>::preAssembleSystem(const core::MechanicalParams* mparams)
{
...

    {
        ...
        getSolveContext()->getObjects(m_forceFields, core::objectmodel::BaseContext::SearchDirection::SearchDown);
        getSolveContext()->getObjects(m_masses, core::objectmodel::BaseContext::SearchDirection::SearchDown);
        getSolveContext()->getObjects(m_mechanicalMappings, core::objectmodel::BaseContext::SearchDirection::SearchDown);
        getSolveContext()->getObjects(m_projectiveConstraints, core::objectmodel::BaseContext::SearchDirection::SearchDown);
...
template <class TMatrix, class TVector>
SReal MatrixLinearSystem<TMatrix, TVector>::getFactorIncludingRayleighDamping(
    const sofa::core::MechanicalParams* mparams, const sofa::core::behavior::BaseMass* mass)
{
    return sofa::core::mechanicalparams::mFactorIncludingRayleighDamping(mparams, mass->rayleighMass.getValue());
}

template <class TMatrix, class TVector>
SReal MatrixLinearSystem<TMatrix, TVector>::getFactorIncludingRayleighDamping(
    const sofa::core::MechanicalParams* mparams, const sofa::core::behavior::BaseForceField* forceField)
{
    return sofa::core::mechanicalparams::kFactorIncludingRayleighDamping(mparams, forceField->rayleighStiffness.getValue());
}

template <class TMatrix, class TVector>
SReal MatrixLinearSystem<TMatrix, TVector>::getFactorIncludingRayleighDamping(
    const sofa::core::MechanicalParams* mparams, const sofa::core::BaseMapping* mapping)
{
    SOFA_UNUSED(mapping);
...
template <class TMatrix, class TVector>
core::objectmodel::BaseContext* MatrixLinearSystem<TMatrix, TVector>::getSolveContext() const
{
