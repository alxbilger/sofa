...
protected:
    ...
    BaseAssemblingMatrixAccumulator<BaseForceField>* createLocalMatrix(BaseForceField* object, SReal factor) const override;
    BaseAssemblingMatrixAccumulator<BaseMass>* createLocalMatrix(BaseMass* object, SReal factor) const override;
    BaseAssemblingMatrixAccumulator<BaseMapping>* createLocalMatrix(BaseMapping* object, SReal factor) const override;

    AssemblingMappedMatrixAccumulator<BaseForceField, SReal>* createLocalMappedMatrix(BaseForceField* object, SReal factor) const override;
    AssemblingMappedMatrixAccumulator<BaseMass, SReal>* createLocalMappedMatrix(BaseMass* object, SReal factor) const override;
    ...
    template<class ComponentType>
    void replaceLocalMatrixMapped(const core::MechanicalParams* mparams, LocalMatrixMaps<ComponentType, Real>& matrixMaps);

    template <class ComponentType>
    void replaceLocalMatricesNonMapped(const core::MechanicalParams* mparams, LocalMatrixMaps<ComponentType, Real>& matrixMaps);


    template<class ComponentType>
    void reinitLocalMatrices(LocalMatrixMaps<ComponentType, Real>& matrixMaps);
