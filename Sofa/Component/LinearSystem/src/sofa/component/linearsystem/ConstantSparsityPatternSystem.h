 ...
 */
class SOFA_COMPONENT_LINEARSYSTEM_API ConstantSparsityPatternSystem : public AssemblingMatrixSystem<
...
public:
    SOFA_CLASS(ConstantSparsityPatternSystem,
        SOFA_TEMPLATE2(AssemblingMatrixSystem, sofa::linearalgebra::CompressedRowSparseMatrix<SReal>, sofa::linearalgebra::FullVector<SReal>));
...
protected:
    ...
    BaseAssemblingMatrixAccumulator<core::matrixaccumulator::Contribution::STIFFNESS>* createLocalStiffnessMatrix(BaseForceField* object, SReal factor) const override;
    BaseAssemblingMatrixAccumulator<core::matrixaccumulator::Contribution::MASS>* createLocalMassMatrix(BaseMass* object, SReal factor) const override;
    BaseAssemblingMatrixAccumulator<core::matrixaccumulator::Contribution::DAMPING>* createLocalDampingMatrix(BaseForceField* object, SReal factor) const override;
    BaseAssemblingMatrixAccumulator<core::matrixaccumulator::Contribution::GEOMETRIC_STIFFNESS>* createLocalGeometricStiffnessMatrix(BaseMapping* object, SReal factor) const override;

    AssemblingMappedMatrixAccumulator<core::matrixaccumulator::Contribution::STIFFNESS, SReal>* createLocalMappedStiffnessMatrix(BaseForceField* object, SReal factor) const override;
    AssemblingMappedMatrixAccumulator<core::matrixaccumulator::Contribution::MASS, SReal>* createLocalMappedMassMatrix(BaseMass* object, SReal factor) const override;
    AssemblingMappedMatrixAccumulator<core::matrixaccumulator::Contribution::DAMPING, SReal>* createLocalMappedDampingMatrix(BaseForceField* object, SReal factor) const override;
