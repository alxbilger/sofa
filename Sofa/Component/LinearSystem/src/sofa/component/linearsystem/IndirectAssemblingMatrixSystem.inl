...
class BlockTypeDeducer_IndirectAssemblingLocalMatrix : public BlockTypeDeducerLocalMatrix<c, BaseIndirectAssemblingLocalMatrix<c> >
{
public:
    using Base = BlockTypeDeducerLocalMatrix<c, BaseIndirectAssemblingLocalMatrix<c> >;
...
protected:
    ...
    typename ReassignedMatrixType::SPtr instantiateLocalMatrix(core::behavior::BlockType blocType) override
    {
        ...
        {
            const auto mat = sofa::core::objectmodel::New<IndirectAssemblingLocalMatrix<c, float> >();
            this->getContext()->addObject(mat);
            return mat;
        }
        if (blocType == core::behavior::getMat33BlocType<float>())
        {
            const auto mat = sofa::core::objectmodel::New<IndirectAssemblingLocalMatrix<c, sofa::type::Mat<3, 3, float> > >();
            this->getContext()->addObject(mat);
            return mat;
        }
        if (blocType == core::behavior::getMat33BlocType<double>())
        {
            const auto mat = sofa::core::objectmodel::New<IndirectAssemblingLocalMatrix<c, sofa::type::Mat<3, 3, double> > >();
            this->getContext()->addObject(mat);
            return mat;
        }

        const auto mat = sofa::core::objectmodel::New<IndirectAssemblingLocalMatrix<c, double> >();
        this->getContext()->addObject(mat);
        return mat;
    }
};
...
template<core::matrixaccumulator::Contribution c, class BlocType, class TStrategy>
IndirectAssemblingLocalMatrix<c, BlocType, TStrategy>::IndirectAssemblingLocalMatrix()
: Inherit1()
...
template<core::matrixaccumulator::Contribution c, class BlocType, class TStrategy>
void IndirectAssemblingLocalMatrix<c, BlocType, TStrategy>::add(const no_check_policy&, sofa::SignedIndex row, sofa::SignedIndex col, float value)
{
...
template<core::matrixaccumulator::Contribution c, class BlocType, class TStrategy>
void IndirectAssemblingLocalMatrix<c, BlocType, TStrategy>::add(const no_check_policy&, sofa::SignedIndex row, sofa::SignedIndex col, double value)
{
...
template<core::matrixaccumulator::Contribution c, class BlocType, class TStrategy>
void IndirectAssemblingLocalMatrix<c, BlocType, TStrategy>::add(const no_check_policy&, sofa::SignedIndex row, sofa::SignedIndex col, const sofa::type::Mat<3, 3, float>& value)
{
...
template<core::matrixaccumulator::Contribution c, class BlocType, class TStrategy>
void IndirectAssemblingLocalMatrix<c, BlocType, TStrategy>::add(const no_check_policy&, sofa::SignedIndex row, sofa::SignedIndex col, const sofa::type::Mat<3, 3, double>& value)
{
...
template<core::matrixaccumulator::Contribution c, class BlocType, class TStrategy>
void IndirectAssemblingLocalMatrix<c, BlocType, TStrategy>::clear()
{
    sofa::helper::getWriteAccessor(d_entries).clear();
}

template<core::matrixaccumulator::Contribution c, class BlocType, class TStrategy>
void IndirectAssemblingLocalMatrix<c, BlocType, TStrategy>::addContributionsToMatrix(sofa::linearalgebra::BaseMatrix* globalMatrix, SReal factor, const sofa::type::Vec2u& positionInMatrix)
{
    if (globalMatrix)
    {
...
template <class TMatrix, class TVector>
template <core::matrixaccumulator::Contribution c>
BaseIndirectAssemblingLocalMatrix<c>* IndirectAssemblingMatrixSystem<TMatrix, TVector>::createLocalMatrix(typename sofa::core::get_base_object_strong<c>::ComponentType* object) const
{
