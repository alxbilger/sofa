...
class BaseIndirectAssemblingLocalMatrix : public sofa::core::get_base_object_strong_type<c>
{
public:
    SOFA_ABSTRACT_CLASS(BaseIndirectAssemblingLocalMatrix, sofa::core::get_base_object_strong_type<c>)
