...
private:
    ...
    BaseIndirectAssemblingLocalMatrix<c>* createLocalMatrix(typename sofa::core::get_base_object_strong<c>::ComponentType* object) const;
...
template<core::matrixaccumulator::Contribution c>
class BaseIndirectAssemblingLocalMatrix_IndirectAssemblingMatrixSystem : public BaseIndirectAssemblingLocalMatrix<c>
{
public:
    SOFA_ABSTRACT_CLASS(BaseIndirectAssemblingLocalMatrix_IndirectAssemblingMatrixSystem, BaseIndirectAssemblingLocalMatrix<c>);
};
...
template<core::matrixaccumulator::Contribution c, class BlocType, class TStrategy = sofa::core::matrixaccumulator::NoIndexVerification>
class IndirectAssemblingLocalMatrix:
public virtual sofa::core::MatrixAccumulatorIndexChecker< BaseIndirectAssemblingLocalMatrix_IndirectAssemblingMatrixSystem<c>, TStrategy>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE3(IndirectAssemblingLocalMatrix, c, BlocType, TStrategy),
        SOFA_TEMPLATE2(sofa::core::MatrixAccumulatorIndexChecker, BaseIndirectAssemblingLocalMatrix_IndirectAssemblingMatrixSystem<c>, TStrategy));
    using Inherit1::add;
