...
class BlockTypeDeducerLocalMatrix :
    public BaseIndirectAssemblingLocalMatrix<c>,
    public BaseBlockTypeDeducerLocalMatrix
{
public:
    using MatrixAccumulator = sofa::core::get_base_object_strong_type<c>;
    SOFA_CLASS(BlockTypeDeducerLocalMatrix, BaseIndirectAssemblingLocalMatrix<c>);
    using ReassignedMatrixType = TReassignedMatrixType;
    using BaseIndirectAssemblingLocalMatrix<c>::add;
