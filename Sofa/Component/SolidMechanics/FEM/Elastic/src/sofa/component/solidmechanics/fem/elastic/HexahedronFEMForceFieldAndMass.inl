...
template<class DataTypes>
void HexahedronFEMForceFieldAndMass<DataTypes>::buildStiffnessMatrix(core::behavior::StiffnessMatrixAccumulator* matrices)
{
    HexahedronFEMForceFieldT::buildStiffnessMatrix(matrices);
}

template<class DataTypes>
void HexahedronFEMForceFieldAndMass<DataTypes>::buildMassMatrix(core::behavior::MassMatrixAccumulator* matrices)
{
    int e = 0;
