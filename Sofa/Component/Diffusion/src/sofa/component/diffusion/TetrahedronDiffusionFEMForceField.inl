...
void TetrahedronDiffusionFEMForceField<DataTypes>::buildStiffnessMatrix(
    core::behavior::StiffnessMatrixAccumulator* matrices)
{
    ...
    for (const auto& edge : edges)
    {
        ...
        matrices->add(N*v1, N*v0, edgeDiffusionCoefficient[edgeId]);
        matrices->add(N*v0, N*v1, edgeDiffusionCoefficient[edgeId]);
        matrices->add(N*v0, N*v0, edgeDiffusionCoefficient[edgeId]);
        matrices->add(N*v1, N*v1, edgeDiffusionCoefficient[edgeId]);
        ++edgeId;
    }
}
