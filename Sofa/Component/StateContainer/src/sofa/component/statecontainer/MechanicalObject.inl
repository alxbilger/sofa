    ...
    , m_gnuplotFileV(nullptr)
{
    ...
    setVecCoord(core::vec_id::write_access::fieldState[core::vec_id::configuration::current], &x);
    setVecCoord(core::vec_id::write_access::fieldState[core::vec_id::configuration::prediction], &xfree);
    setVecCoord(core::vec_id::write_access::fieldState[core::vec_id::configuration::atRest], &x0);
    setVecCoord(core::vec_id::write_access::fieldState[core::vec_id::configuration::reset], &reset_position);
    setVecDeriv(core::vec_id::write_access::fieldState.timeDerivative[core::vec_id::configuration::current], &v);
    ...
    setVecDeriv(core::vec_id::write_access::fieldState.timeDerivative[core::vec_id::configuration::prediction], &vfree);
    setVecDeriv(core::vec_id::write_access::fieldState.timeDerivative[core::vec_id::configuration::reset], &reset_velocity);
...
void MechanicalObject<DataTypes>::init()
{
    ...
    if (read(core::vec_id::read_access::fieldState[core::vec_id::configuration::atRest])->getValue().size() > x_wA.size())
    {
        vOp(core::execparams::defaultInstance(), sofa::core::vec_id::write_access::position, sofa::core::vec_id::read_access::fieldState[core::vec_id::configuration::atRest]);
    }
    ...
    if( read(core::vec_id::read_access::fieldState[core::vec_id::configuration::atRest])->getValue().size()!=x_wA.size() )
    {
        ...
        if( restScale.getValue()!=1 )
            vOp(core::execparams::defaultInstance(), sofa::core::vec_id::write_access::fieldState[core::vec_id::configuration::atRest], core::ConstVecId::null(), sofa::core::vec_id::write_access::position, restScale.getValue());
        else
            vOp(core::execparams::defaultInstance(), sofa::core::vec_id::write_access::fieldState[core::vec_id::configuration::atRest], sofa::core::vec_id::write_access::fieldState[core::vec_id::configuration::current]);
    }
