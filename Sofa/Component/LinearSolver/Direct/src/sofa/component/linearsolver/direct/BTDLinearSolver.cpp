...
namespace sofa::component::linearsystem
{
    ...
    template class SOFA_COMPONENT_LINEARSOLVER_DIRECT_API IndirectAssemblingMatrixSystem< linearalgebra::BTDMatrix<6, SReal>, linearalgebra::BlockVector<6, SReal> >;
