...
template<>
struct get_abstract_strong<core::BaseMapping>
{
    using type = MappingMatrixAccumulator;
    using ComponentType = core::BaseMapping;
};

using BaseLocalMappingMatrix = BaseMatrixAccumulatorComponent<core::BaseMapping>;

template<>
struct get_base_object_strong<core::BaseMapping>
{
    using type = BaseLocalMappingMatrix;
    using ComponentType = core::BaseMapping;
};

template<>
struct get_list_abstract_strong<core::BaseMapping>
{
