...
template<>
struct get_abstract_strong<core::behavior::BaseMass>
{
    using type = behavior::MassMatrixAccumulator;
    using ComponentType = core::behavior::BaseMass;
};

using BaseMassMatrixAccumulator = BaseMatrixAccumulatorComponent<behavior::BaseMass>;

template<>
struct get_base_object_strong<core::behavior::BaseMass>
{
    using type = BaseMassMatrixAccumulator;
    using ComponentType = core::behavior::BaseMass;
};

template<>
struct get_list_abstract_strong<core::behavior::BaseMass>
{
