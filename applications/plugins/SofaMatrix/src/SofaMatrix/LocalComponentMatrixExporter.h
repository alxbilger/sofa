...
class LocalComponentMatrixExporter :
    public sofa::core::BaseMatrixAccumulatorComponent<ComponentType>,
    public sofa::simulation::BaseSimulationExporter
{
public:
    SOFA_CLASS2(LocalComponentMatrixExporter, sofa::core::BaseMatrixAccumulatorComponent<ComponentType>, sofa::simulation::BaseSimulationExporter);
    ...
    static bool canCreate(LocalComponentMatrixExporter<ComponentType, TMatrix>* obj, core::objectmodel::BaseContext* context, core::objectmodel::BaseObjectDescription* arg)
    {
        if (auto* linearSolver = context->get<sofa::core::behavior::LinearSolver >())
        {
            ...
            if (linearSolver->getTemplateName() == LocalComponentMatrixExporter<ComponentType, TMatrix>::GetClass()->templateName)
            {
                return sofa::core::BaseMatrixAccumulatorComponent<ComponentType>::canCreate(obj, context, arg);
            }
        }
        return false;
    }
